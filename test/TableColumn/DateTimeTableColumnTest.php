...
class DateTimeTableColumnTest extends TestCase
{
  ...
  public function test1(): void
  {
    ...
    self::assertEquals('<td class="ot ot-cell ot-datetime" data-value="2004-07-13 12:13:14">Tuesday 13th of July 2004 12:13:14 PM</td>', $ret);
  }
  ...
  public function test2(): void
  {
    ...
    self::assertEquals('<td class="ot ot-cell ot-datetime">not a date and time</td>', $ret);
  }
  ...
  public function test3(): void
  {
    ...
    self::assertEquals('<td class="ot ot-cell ot-datetime"></td>', $ret);
  }
