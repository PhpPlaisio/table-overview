...
class DateTableColumnTest extends TestCase
{
  ...
  public function testEmptyDate1(): void
  {
    ...
    self::assertEquals('<td class="ot ot-cell ot-date"></td>', $ret);
  }
  ...
  public function testInvalidDate1(): void
  {
    ...
    self::assertEquals('<td class="ot ot-cell ot-date">not a date</td>', $ret);
  }
  ...
  public function testValidDate1(): void
  {
    ...
    self::assertEquals('<td class="ot ot-cell ot-date" data-value="2004-07-13">Tuesday 13th of July 2004</td>', $ret);
  }
