...
class IpTableColumnTest extends TestCase
{
  ...
  public function getValidValues(): array
  {
    ...
    $cases[] = ['ip'         => inet_pton('127.0.0.1'),
                'data-value' => '00000000000000000000ffff7f000001',
                'html'       => '127.0.0.1'];
    ...
    $cases[] = ['ip'         => inet_pton('fe80::8000:777a:8a39:80bd'),
                'data-value' => 'fe800000000000008000777a8a3980bd',
   ...
   */
  public function testInvalidValues(mixed $value, string $html): void
  {
    $column = new IpTableColumn('header', 'ip');
    ...
    self::assertEquals($expected, $ret, var_export($value, true));
  }
   ...
   */
  public function testValidValues(mixed $value, string $dataValue, string $html): void
  {
    $column = new IpTableColumn('header', 'ip');
